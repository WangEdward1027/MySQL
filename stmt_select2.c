//换一张表查询，学生表： id | name | birth | English | Math | Chinese 
...
int main()
{
    ...
    res_bind[2].buffer = res_birth;
    res_bind[2].buffer_length = sizeof(res_birth);
    
    res_bind[3].buffer_type = MYSQL_TYPE_LONG;
    res_bind[3].buffer = &res_English;
    res_bind[3].buffer_length = sizeof(res_English);

    res_bind[4].buffer_type = MYSQL_TYPE_LONG;
    res_bind[4].buffer = &res_Math;
    res_bind[4].buffer_length = sizeof(res_Math);

    res_bind[5].buffer_type = MYSQL_TYPE_LONG;
    res_bind[5].buffer = &res_Chinese;
    res_bind[5].buffer_length = sizeof(res_Chinese);
    ...
    while(1) {
        ...
        //打印一行数据
        printf("%d\t %s\t %s\t %d\t %d\t %d\t \n", 
               res_id, res_name, res_birth, res_English , res_Math, res_Chinese);
    }
